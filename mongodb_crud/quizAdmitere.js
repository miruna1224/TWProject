(function () {
    const myQuestions = [
        {
            question: "Fie funcita f : R -> R f(x) = e^x(x^2 - 5x +7). Determinati ecuatia asimptotei spre −∞ la graficul functiei f si punctele de extrem local ale acestei functii:",
            answers: {
                a: "nu stiu momentan",
                b: "nu se poate calcula",
                c: "o voi calcula, doar sa am timp :)",
                d: "Nu exita asa ceva"
            },
            correctAnswer: "c"
        },
        {
            question: "Fie ABCDEF un hexagon regulat de latura 2. Calculati aria triunghiului ACE:",
            answers: {
                a: "6",
                b: "2",
                c: "8",
